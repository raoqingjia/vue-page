<template>
  <div>
    ...
    <ul class="info-rowspan char-rowspan">
      <template  v-for="(charItem , charIndex) in skuItem.bizCharSpecLst">
        <li class="clearfix"  v-if="charItem.groupNum === groupItem.groupNum" :class="{}">
          <label class="char-name">
