    ...
    $.extend(true, myflow.config.tools.states, {
       ...
       cancel_mark: {
        ...
        error: {
            ...
            name: {text: '<<error>>'},
            text: {text: '错误'},
            img: {src: 'img/48/error.png', width: 48, height: 48},
            attr: {width: 50, heigth: 50},
            props: {
                show: {
        ...
        error_active: {
            ...
            name: {text: '<<error>>'},
            text: {text: '错误'},
            img: {src: 'img/48/error_active.png', width: 48, height: 48},
            attr: {width: 50, heigth: 50},
            props: {
                show: {
                    name: 'show', label: '显示', value: '错误', editor: function () {
        ...
        error_mark: {
            ...
            name: {text: '<<error>>'},
            text: {text: '错误'},
            img: {src: 'img/48/error_mark.png', width: 48, height: 48},
            attr: {width: 50, heigth: 50},
            props: {
                show: {
                    name: 'show', label: '显示', value: '错误', editor: function () {
        ...
        task: {
            ...
            name: {text: '<<task>>'},
            text: {text: '任务'},
            attr: {width: 100, height: 50, fill: '#f6f7ff', stroke: "#cccccc", r: 15},
        ...
        auto: {
            ...
            text: {text: '自动'},
            img: {src: 'img/48/task_sql.png', width: 0, height: 0},
            attr: {width: 100, height: 50, fill: '#f6f7ff', stroke: "#5f8d7c", r: 50},
            props: {
                show: {
        ...
        'subprocess': {
            ...
            text: {text: '子流程'},
            img: {src: 'img/48/task_sql.png', width: 0, height: 0},
            attr: {width: 100, height: 50, fill: '#f6f7ff', stroke: "#fabc9e", r: 0},
            props: {
                show: {
